...
public final class G3Constants {
    ...
    public static final int NEW_SINGLE_1_VALUE = 0;

    public static final int NEW_CONNECTED_2_VALUE = 20; // ex: _ _ X X _    (0 space)
    public static final int NEW_DISCONNECTED_2_VALUE = 20; // ex: _ X _ X _ (1 space)
    public static final int NEW_GAP_2_VALUE = 20; // ex: X _ _ X _  (2 spaces)
    public static final int NEW_SEVERED_2_VALUE = 20; // ex: X _ _ _ X  (3 spaces)

    public static final int NEW_CONNECTED_3_VALUE = 50; // ex: X X X _ _ (0 space)
    public static final int NEW_DISCONNECTED_3_VALUE = 50; // ex: X _ X X _ (1 space)
    public static final int NEW_GAP_3_VALUE = 50;   // ex: X _ _ X X (2 spaces)
    public static final int NEW_BROKEN_3_VALUE = 50; // ex: X _ X _ X (2 spaces spread out)
